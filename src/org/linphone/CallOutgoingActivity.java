...
//		number = (TextView) findViewById(R.id.contact_number);
	...
	protected void onResume() {
		...
		if(LinphoneUtils.mLinphoneAddress != null) {
			address = LinphoneUtils.mLinphoneAddress;
			LinphoneUtils.mLinphoneAddress = null;
		}
...
//		number.setText(address.asStringUriOnly());
	...
	public void loadInfoSaldo() {
		//obtiene el balance de la DB
		Balance mBalance = Data.getUserBalance();
		if(mBalance.getCurrency().equals("EUR")) {
		...
		TextView infoSaldo = (TextView) status.getView().findViewById(R.id.info_saldo);
		infoSaldo.setOnClickListener(this);

		//define el saldo disponible en la barra superior junto a la moneda
		infoSaldo.setText(mBalance.getAmount() + " " + ApplicationConfig.currency_char);
	}
