...
public class LinphonePreferences {
	...
	public static class AccountBuilder {
		...
		public void saveNewAccount() throws LinphoneCoreException {
			...
			LinphoneAddress identityAddr = LinphoneCoreFactory.instance().createLinphoneAddress(identity); // sip:Manolo
			...
			prxCfg.enableAvpf(tempAvpfEnabled); // false
			prxCfg.setAvpfRRInterval(tempAvpfRRInterval); // 0
			prxCfg.enableQualityReporting(tempQualityReportingEnabled); // false
			prxCfg.setQualityReportingCollector(tempQualityReportingCollector); // null
			prxCfg.setQualityReportingInterval(tempQualityReportingInterval); // 0
